...
const Footer = () => {
  ...
  return (
    ...
    ">
      {/* Background Pattern */}
      <div className="absolute inset-0 pattern-geometric    background-image: 
    ...
    background-position: 0 0, 30px 30px, 0 0, 20px 20px; opacity-10"></div>
      ...
      <div className="relative z-10">
        ...
        <div className="container mx-auto px-4 lg:px-8 py-16">
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 text-start">
            ...
            {/* Contact Info */}
            <div>
              <h4 className="text-xl font-semibold text-secondary mb-6">Contact Info</h4>
              <div className="space-y-4 text-primary-foreground/80 flex flex-col items-base">
                <p>
                  3, Rue Fefnand Raynaud<br />
                  63360 Gerzat<br />
                  France
                </p>
                <p>
                  <a href="tel:+33-0659149899" className="hover:text-secondary transition-colors">
                     06 59 14 98 99
                  </a>
                </p>
          ...
          <div className="container mx-auto px-4 lg:px-8 py-6">
            <div className="flex flex-col md:flex-row items-center justify-between">
              <p className="text-primary-foreground/60 text-sm mb-4 md:mb-0">
                © {new Date().getFullYear()} All Rights Reserved – Tailor Studio. Design & Development by Web Witch.
              </p>
